...
This file contains a combination of src code from the disassembly of the Atari-ST CP/M Emulator v8.4 by SoftDesign Munich, plus a recreation of the jump table and labels generated by scripts I wrote.  The current addresses of this generated source starts at address 0 rather than the original address.  As this is primarily meant to provide some insight into how this emulator is written, I felt it was easier to understand with all the jump tables and code placed together without all the other support code interweaved.

Note: I may include some of these scripts in the future, but as they are intended for a one time use, the code may be a little messy or poorly structured.
