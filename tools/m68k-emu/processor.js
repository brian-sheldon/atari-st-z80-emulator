...
EstyJs.Processor = function (opts) {
    ...
    function interrupt(nr) {
        ...
        if (nr == 6) {
            ...
            // bjs exception(mfp.getInterrupt());
        } else {
    ...
    self.runCode = function () {
        ...
        while (tot_cycles < frameRowCycles) {
            ...
            // bjs pendingInterrupts[6] = mfp.doInterrupts(self);
            ...
            try {
                console.log( hex6( regs.pc ), hex4( prefetch1 ), hex4( prefetch2 ) );
                var op = prefetch1;
                prefetch1 = prefetch2;
                fault.pc = regs.pc;
                fault.op = op;
